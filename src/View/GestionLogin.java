...
public class GestionLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/boutton_large.png"))); // NOI18N
        btn.setText("jLabel1");
        ...
        back.setText("Login");
        getContentPane().add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 50, 30));
        ...
        back1.setText("Pwd");
        getContentPane().add(back1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 40, 40));
        ...
        getContentPane().add(txtpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 330, 40));
        ...
        getContentPane().add(close, new org.netbeans.lib.awtextra.AbsoluteConstraints(464, 0, 30, 40));
        ...
        getContentPane().add(MouveJframe, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 430, 40));
        ...
        getContentPane().add(Description, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 410, 30));

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gestiongarderie/images/Gestiongarderie.png"))); // NOI18N
    ...
    private void resizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resizeMouseClicked
        this.setState(GestionLogin.ICONIFIED);
    ...
    private void btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMouseClicked
      /*
        Login newLogin = new Login();
				newLogin.setLogin(txtlogin.getText());
				newLogin.setPassword(txtpassword.getText());
                                
                                
                                String lo = txtlogin.getText().toString();
        ...
        */
         ...
         String requete ="select * from directeur where login=? and password=?";
        try{
            ps = conn.prepareStatement(requete);
            ps.setString(1,txtlogin.getText());
            ps.setString(2,txtpassword.getText());
       ...
       /*
        ...
        Directeur newDirecteur = new Directeur();
        
        
        DirecteurController dc=new DirecteurController();
        
        try {
            if(dc.verif_conn(log, pass))
            {
